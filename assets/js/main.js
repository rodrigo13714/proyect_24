...
$(document).ready(function($) {
    ...
    function toggleMensaje() {
        const mensajeOverlay = document.getElementById('message-overlay');
        mensajeOverlay.classList.toggle('active');
    }

    // Asignar la función toggleMensaje al hacer clic en el botón de mensaje
    document.querySelector('.play-button').addEventListener('click', toggleMensaje);
